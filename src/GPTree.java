/**
This ﬁle: GPTree.java
Programmer: Siddarth Ramadoss (sramados@andrew.cmu.edu)
Course/Section: 90-744::C
Assignment: Homework 7-1
Description: GPTree class which creates a tree of specified depth, randomly from a set of operands and terminals
Method: Calculates fitness after evaluating the tree.
